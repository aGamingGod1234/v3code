...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@v3tools/shared/git`, `@v3tools/shared/DrainableWorker`) — no barrel index.
