...
import { EDITORS, OpenError, type EditorId } from "@v3tools/contracts";
import { isCommandAvailable, type CommandAvailabilityOptions } from "@v3tools/shared/shell";
...
export { OpenError };
export { isCommandAvailable } from "@v3tools/shared/shell";
