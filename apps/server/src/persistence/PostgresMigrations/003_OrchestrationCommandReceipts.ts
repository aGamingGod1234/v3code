// Postgres port of SQLite migration 002_OrchestrationCommandReceipts.
//
// No dialect-specific deltas beyond the file rename. All columns are
// TEXT/INTEGER and the indexes are portable.
