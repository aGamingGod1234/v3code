import type { ProviderRuntimeEvent } from "@v3tools/contracts";
import { ThreadId } from "@v3tools/contracts";
import { DEFAULT_SERVER_SETTINGS } from "@v3tools/contracts/settings";
