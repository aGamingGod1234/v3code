...
const PATH_CAPTURE_START = "__V3CODE_PATH_START__";
const PATH_CAPTURE_END = "__V3CODE_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__V3CODE_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__V3CODE_ENV_${name}_END__`;
}
